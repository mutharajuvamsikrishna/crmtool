...
import { getSupAdminbyAdminProfiles,superAdmRegisterbyAdmin } from "./Services/Api";
import { useLocation } from "react-router-dom";
import "./ViweAll.css";

const SpecSupAdmByAdm = () => {
...
const [loading,setLoading]=useState(false);
  ...
  const fetchEmployeeData = (email) => {
    getSupAdminbyAdminProfiles(email)
      .then((response) => {
  ...
  const confirmEdit = (event) => {
    ...
    superAdmRegisterbyAdmin(formData)
      .then((response) => {
...
export default SpecSupAdmByAdm;
